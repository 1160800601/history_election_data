...
STATE_ELECTORAL_VOTE = {'Alabama': 9, 'Alaska': 3, 'Arizona': 11, 'Arkansas': 4, 'California': 55,
          ...
          'Vermont': 3, 'Virginia': 13, 'Washington': 12, 'West Virginia': 5, 'Wisconsin': 10, 'Wyoming': 3}
...
class his_data:
    ...
    def state_history_election(self, state):
        ...
        sns.pointplot(x=YEARS, y=d_1)
        # sns.pointplot(x=years, y=1)
        file_path = 'fig/' + str(round(d_1[10], 3)) + '_' + state + '.png'
